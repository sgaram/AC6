...
poll = LinePoll(cl)
call = cl
creator = ["u3174ed6825bf4aa9ed747892ad4f5325"]
owner = ["u3174ed6825bf4aa9ed747892ad4f5325"]
admin = ["u3174ed6825bf4aa9ed747892ad4f5325"]
staff = ["u3174ed6825bf4aa9ed747892ad4f5325"]
mid = cl.getProfile().mid
Amid = ki.getProfile().mid
Bmid = kk.getProfile().mid
Cmid = kc.getProfile().mid
Zmid = sw.getProfile().mid
Xmid = sc.getProfile().mid
KAC = [cl,ki,kk,kc,sw,sc]
ABC = [ki,kk,kc,sw,sc]
Bots = [mid,Amid,Bmid,Cmid,Zmid,Xmid]
Sepri = admin + staff
...
responsename5 = sc.getProfile().displayName
                        ...
                        try:
                            ...
                            try:
                                ...
                                try:
                                    ...
                                    try:
                                        sc.kickoutFromGroup(op.param1,[op.param2])
                                        sc.inviteIntoGroup(op.param1,[op.param3])
                                        cl.acceptGroupInvitation(op.param1)
                                    except:
                                        try:
                                            kk.kickoutFromGroup(op.param1,[op.param2])
            ...
            if Xmid in op.param3:
                ...
                if op.param2 in staff:
                    ...
                    try:
                        ki.kickoutFromGroup(op.param1,[op.param2])
                        ki.inviteIntoGroup(op.param1,[op.param3])
                        sc.acceptGroupInvitation(op.param1)
                    except:
                        try:
                            kk.kickoutFromGroup(op.param1,[op.param2])
                            kk.inviteIntoGroup(op.param1,[op.param3])
               ...
               if msg.contentType == 13:
                 if wait["contact"] == True:
                    ...
                    if 'displayName' in msg.contentMetadata:
                        ...
                        cl.sendMessage(msg.to,"🇮🇩\⊰♪͜͡◈Nama : " + msg.contentMetadata["displayName"] + "\n🇮🇩\⊰♪͜͡◈MID : " + msg.contentMetadata["mid"] + "\n🇮🇩\⊰♪͜͡◈Status Msg : " + contact.statusMessage + "\n🇮🇩\⊰♪͜͡◈Picture URL : http://dl.profile.line-cdn.net/" + contact.pictureStatus)
                        cl.sendImageWithURL(msg.to, image)
               ...
               if msg.contentType == 1:
                 if msg._from in admin:
                        if Amid in Setmain["ARfoto"]:
                            ...
                            path = sc.downloadObjectMsg(msg_id)
                            del Setmain["ARfoto"][Xmid]
                            sc.updateProfilePicture(path)
                            sc.sendMessage(msg.to,"Foto berhasil dirubah")
               ...
               if msg.contentType == 1:
                 if msg._from in admin:
                   if settings["changePicture"] == True:
                     ...
                     path5 = sc.downloadObjectMsg(msg_id)
                     ...
                     sc.updateProfilePicture(path3)
                     sc.sendMessage(msg.to, "Berhasil mengubah foto profile bot")
                        ...
                        if cmd == "self on":
                          ...
                          if wait["selfbot"] == True:
                            if msg._from in admin:
                                tz = pytz.timezone("Asia/Jakarta")
                                timeNow = datetime.now(tz=tz)
                                md = "🇮🇩\⊰♪͜͡◈FUNKZHER PROTECTION🇮🇩\⊰♪͜͡◈\n"
                                if wait["sticker"] == True: md+="🇮🇩\⊰♪͜͡◈Sticker「ON」\n"
                                ...
                                if wait["Mentionkick"] == True: md+="🇮🇩\⊰♪͜͡◈Notag「ON」\n"
                                else: md+="🇮🇩\⊰♪͜͡◈Notag「OFF」\n"
                                ...
                                if msg.to in ghost: md+="🇮🇩\⊰♪͜͡◈Ghost「ON」\n"
                                else: md+="🇮🇩\⊰♪͜͡◈Ghost「OFF」\n"                                   
                                cl.sendMessage(msg.to, md+"\nTanggal : "+ datetime.strftime(timeNow,'%Y-%m-%d')+"\nJam [ "+ datetime.strftime(timeNow,'%H:%M:%S')+" ]")

                        elif cmd == ".key" or text.lower() == 'key':
                            cl.sendMessage(msg.to, "1. baper \n2. pm \n3. kojom \n4. sue \n5. dudul \n6. asem \n7. nah \n8. bah \n9. aih \n10.adipati \n11.ngopi \n12.iya \n13.naik \n14.tidak \nFunkzher bot protection")
                        elif cmd == "baper" or text.lower() == 'laper':
                            cl.sendMessage(msg.to, "baper,, puskun ae beib ")
                        elif cmd == "pm" or text.lower() == 'pm':
                            cl.sendMessage(msg.to, "moh,. wong dirimu desah ae kerjaanne ")
                        elif cmd == "nah" or text.lower() == 'nah':
                            cl.sendMessage(msg.to, "nah,, nah,, tak tikung koe.. kapok wkwkwkk ")
                        elif cmd == "kojom" or text.lower() == 'mojok':
                            cl.sendMessage(msg.to, "mojok ndi,. aku melu...")
                        elif cmd == "asem" or text.lower() == 'sem':
                            cl.sendMessage(msg.to, "iya, kamu memang bau asem..wkwkwkkk")
                        elif cmd == "sue" or text.lower() == 'suek':
                            cl.sendMessage(msg.to, "sue, mbahmu noh.. sue hahahahaa...")
                        elif cmd == "bah" or text.lower() == 'bah':
                            cl.sendMessage(msg.to, "bah piye~ mbahmu hahahaa...")
                        elif cmd == "aih" or text.lower() == 'aih':
                            cl.sendMessage(msg.to, "ah ah ah ih ih ih...")
                        elif cmd == "naik" or text.lower() == 'naik':
                            cl.sendMessage(msg.to, "No.. aim biasa dinaikin..")
                        elif cmd == "tidak" or text.lower() == 'bukan':
                            cl.sendMessage(msg.to, "No.. matamu memang juling..")  	
                        elif cmd == "adipati" or text.lower() == 'adipati':
                            cl.sendMessage(msg.to, "wong edan dipanggil2, kan sue....")       	
                        elif cmd == "ngopi" or text.lower() == 'kopi':
                            cl.sendMessage(msg.to, "aku ra biasa ngopi,. biasane nenen.")         	
                        elif cmd == "iya" or text.lower() == 'ya':
                            cl.sendMessage(msg.to, "iya,,, matamu juling..")      	
                        elif cmd == "dudul" or text.lower() == 'dodol':
                            cl.sendMessage(msg.to, "hooh, aku memang dudul,. dirimu noh vekok.. wkwkwkkk")
                        elif cmd == "sepri" or text.lower() == 'sepri':
                            cl.sendImageWithURL(msg.to,"https://1.bp.blogspot.com/-vdKxC2_KfsQ/W_ZhTOYrh8I/AAAAAAAAAQQ/F9uzi2fSWtkS7JLacRbNo94-oKksIUERgCLcBGAs/s1600/IMG_20180716_233657.JPG") 
                          ...
                          if wait["selfbot"] == True:
                            if msg._from in admin:
                               ...
                               key1 = key["MENTIONEES"][0]["M"]
                               mi = cl.getContact(key1)
                               cl.sendMessage(msg.to, "🇮🇩\⊰♪͜͡◈Nama : "+str(mi.displayName)+"\n🇮🇩\⊰♪͜͡◈Mid : " +key1+"\n🇮🇩\⊰♪͜͡◈Status Msg"+str(mi.statusMessage))
                               cl.sendMessage(msg.to, None, contentMetadata={'mid': key1}, contentType=13)
                          ...
                          if wait["selfbot"] == True:
                            if msg._from in admin:
                               try:
                                   ...
                                   sc.removeAllMessages(op.param2)
                          ...
                          if msg._from in admin:
                            try:
                                ...
                                cl.sendMessage(msg.to, "🇮🇩\⊰♪͜͡◈FUNKZHER Fams Grup Info\n\n🇮🇩\⊰♪͜͡◈Nama Group : {}".format(G.name)+ "\n🇮🇩\⊰♪͜͡◈ID Group : {}".format(G.id)+ "\n🇮🇩\⊰♪͜͡◈Pembuat : {}".format(G.creator.displayName)+ "\n🇮🇩\⊰♪͜͡◈Waktu Dibuat : {}".format(str(timeCreated))+ "\n🇮🇩\⊰♪͜͡◈Jumlah Member : {}".format(str(len(G.members)))+ "\n🇮🇩\⊰♪͜͡◈Jumlah Pending : {}".format(gPending)+ "\n🇮🇩\⊰♪͜͡◈Group Qr : {}".format(gQr)+ "\n🇮🇩\⊰♪͜͡◈Group Ticket : {}".format(gTicket))
                          ...
                          if msg._from in admin:
                            ...
                            try:
                                ...
                                timeCreated = []
                                timeCreated.append(time.strftime("%d-%m-%Y [ %H:%M:%S ]", time.localtime(int(G.createdTime) / 1000)))
                                ret_ += "🇮🇩\⊰♪͜͡◈FUNKZHER Fams Grup Info\n"
                                ret_ += "\n🇮🇩\⊰♪͜͡◈Nama Group : {}".format(G.name)
                                ret_ += "\n🇮🇩\⊰♪͜͡◈ID Group : {}".format(G.id)
                                ret_ += "\n🇮🇩\⊰♪͜͡◈Pembuat : {}".format(gCreator)
                                ret_ += "\n🇮🇩\⊰♪͜͡◈Waktu Dibuat : {}".format(str(timeCreated))
                                ret_ += "\n🇮🇩\⊰♪͜͡◈Jumlah Member : {}".format(str(len(G.members)))
                                ret_ += "\n🇮🇩\⊰♪͜͡◈Jumlah Pending : {}".format(gPending)
                                ret_ += "\n🇮🇩\⊰♪͜͡◈Group Qr : {}".format(gQr)
                          ...
                          if msg._from in admin:
                            ...
                            try:
                                ...
                                cl.sendMessage(to,"🇮🇩\⊰♪͜͡◈Group Name : [ " + str(G.name) + " ]\n\n   [ List Member ]\n" + ret_ + "\n\n「Total %i Members」" % len(G.members))
                            except: 
                                pass
...
#===========BOT UPDATE============#
                        elif cmd == "tagall" or text.lower() == '69':
                          if wait["selfbot"] == True:
                            if msg._from in admin:
                          ...
                          if wait["selfbot"] == True:
                            if msg._from in admin:
                                ...
                                cl.sendMessage(msg.to,"🇮🇩\⊰♪͜͡◈FUNKZHER  bot\n\n"+ma+"\nTotal「%s」 Bots" %(str(len(Bots))))
                          ...
                          if wait["selfbot"] == True:
                            if msg._from in admin:
                                ...
                                cl.sendMessage(msg.to,"🇮🇩\⊰♪͜͡◈FUNKZHER  admin\n\nSuper admin:\n"+ma+"\nAdmin:\n"+mb+"\nStaff:\n"+mc+"\nTotal「%s」 Sepri" %(str(len(owner)+len(admin)+len(staff))))
                          ...
                          if wait["selfbot"] == True:
                            if msg._from in admin:
                                ...
                                sc.sendMessage(msg.to,responsename5)

                        elif cmd == "invitebot":
                          if wait["selfbot"] == True:
                            if msg._from in admin:
                                try:
                                    anggota = [Bmid,Cmid,Amid,Zmid,Xmid]
                                    cl.inviteIntoGroup(msg.to, anggota)
                                    kk.acceptGroupInvitation(msg.to)
                                    kc.acceptGroupInvitation(msg.to)
                                    ki.acceptGroupInvitation(msg.to)
                                    sw.acceptGroupInvitation(msg.to)
                                    sc.acceptGroupInvitation(msg.to)
                                except:
                                    pass
                          ...
                          if wait["selfbot"] == True:
                            if msg._from in admin:
                                ...
                                sc.acceptGroupInvitationByTicket(msg.to,Ticket)
                          ...
                          if wait["selfbot"] == True:
                            if msg._from in admin:
                                ...
                                cl.sendMessage(msg.to, "🇮🇩\⊰♪͜͡◈FUNKZHER Speed respon\n\n - Get Profile\n   %.10f\n - Get Contact\n   %.10f\n - Get Group\n   %.10f" % (get_profile_time/3,get_contact_time/3,get_group_time/3))

                        elif cmd == "speed" or cmd == "sp":
                          if wait["selfbot"] == True:
                            if msg._from in admin:
                               start = time.time()
                               cl.sendMessage(msg.to, "hitung utang...")
...
#===========Hiburan============#
                          ...
                          if msg._from in admin:
                            ...
                            with requests.session() as web:
                                ...
                                if "result" not in data:
                                    ret_ = "「Status Cuaca」"
                                    ret_ += "\n🇮🇩\⊰♪͜͡◈Lokasi : " + data[0].replace("Temperatur di kota ","")
                                    ret_ += "\n🇮🇩\⊰♪͜͡◈Suhu : " + data[1].replace("Suhu : ","") + " C"
                                    ret_ += "\n🇮🇩\⊰♪͜͡◈Kelembaban : " + data[2].replace("Kelembaban : ","") + " %"
                                    ret_ += "\n🇮🇩\⊰♪͜͡◈Tekanan udara : " + data[3].replace("Tekanan udara : ","") + " HPa"
                                    ret_ += "\n🇮🇩\⊰♪͜͡◈Kecepatan angin : " + data[4].replace("Kecepatan angin : ","") + " m/s"
                                    ret_ += "\n\nTanggal : " + datetime.strftime(timeNow,'%Y-%m-%d')
                                    ret_ += "\nJam : " + datetime.strftime(timeNow,'%H:%M:%S')
                                cl.sendMessage(msg.to, str(ret_))
                          ...
                          if msg._from in admin:
                            try:
                                ...
                                for s in stream:
                                    ...
                                    author = '\n\n🇮🇩\⊰♪͜͡◈Author : ' + str(vid.author)
                                    durasi = '\n🇮🇩\⊰♪͜͡◈Duration : ' + str(vid.duration)
                                    suka = '\n🇮🇩\⊰♪͜͡◈Likes : ' + str(vid.likes)
                                    rating = '\n🇮🇩\⊰♪͜͡◈Rating : ' + str(vid.rating)
                                    deskripsi = '\n🇮🇩\⊰♪͜͡◈Deskripsi : ' + str(vid.description)
                          ...
                          if msg._from in admin:
                            try:
                                ...
                                link = "🇮🇩\⊰♪͜͡◈Link : " + "https://www.instagram.com/" + instagram
                                text = "🇮🇩\⊰♪͜͡◈Name : "+namaIG+"\n🇮🇩\⊰♪͜͡◈Username : "+usernameIG+"\n🇮🇩\⊰♪͜͡◈Biography : "+bioIG+"\n🇮🇩\⊰♪͜͡◈Follower : "+followerIG+"\n🇮🇩\⊰♪͜͡◈Following : "+followIG+"\n🇮🇩\⊰♪͜͡◈Post : "+mediaIG+"\n🇮🇩\⊰♪͜͡◈Verified : "+verifIG+"\n🇮🇩\⊰♪͜͡◈Private : "+privateIG+"" "\n" + link
                          ...
                          if msg._from in admin:
                            ...
                            cl.sendMessage(msg.to,"🇮🇩\⊰♪͜͡◈I N F O R M A S I 🇮🇩\⊰♪͜͡◈\n\n"+"🇮🇩\⊰♪͜͡◈Date Of Birth : "+lahir+"\n🇮🇩\⊰♪͜͡◈Age : "+usia+"\n🇮🇩\⊰♪͜͡◈Ultah : "+ultah+"\n🇮🇩\⊰♪͜͡◈Zodiak : "+zodiak)
                            ...
                            if msg._from in admin:
                              if wait["blacklist"] == {}:
                                ...
                                for m_id in wait["blacklist"]:
                                    ...
                                    ma += str(a) + ". " +cl.getContact(m_id).displayName + "\n"
                                cl.sendMessage(msg.to,"🇮🇩\⊰♪͜͡◈FUNKZHER Blacklist User\n\n"+ma+"\nTotal「%s」Blacklist User" %(str(len(wait["blacklist"]))))
                            ...
                            if msg._from in admin:
                              if wait["Talkblacklist"] == {}:
                                ...
                                for m_id in wait["Talkblacklist"]:
                                    ...
                                    ma += str(a) + ". " +cl.getContact(m_id).displayName + "\n"
                                cl.sendMessage(msg.to,"🇮🇩\⊰♪͜͡◈FUNKZHER Talkban User\n\n"+ma+"\nTotal「%s」Talkban User" %(str(len(wait["Talkblacklist"]))))
                          ...
                          if wait["selfbot"] == True:
                              if settings["autoJoinTicket"] == True:
                                 ...
                                 for ticket_id in n_links:
                                     ...
                                     group4 = sw.findGroupByTicket(ticket_id)
                                     sw.acceptGroupInvitationByTicket(group4.id,ticket_id)
                                     sw.sendMessage(msg.to, "Masuk : %s" % str(group.name))    
                                     group5 = sw.findGroupByTicket(ticket_id)
                                     sc.acceptGroupInvitationByTicket(group5.id,ticket_id)
                                     sc.sendMessage(msg.to, "Masuk : %s" % str(group.name))
