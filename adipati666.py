...
cl = LineClient(authToken='EAIzBmFD046wlQd4XtH0.VRuLrYpTeu/7GJJyyLa+Ga.u0mM9OHn28d5H/jKmv0el3OEBPWRD2cu4bF1dQBH/EY=')
cl.log("Auth Token : " + str(cl.authToken))
channel = LineChannel(cl)
cl.log("Channel Access Token : " + str(channel.channelAccessToken))

ki = LineClient(authToken='EALJsapgXgNrkdzYAxA7.ifquVXCcHx7ObaKS6sWnHW.QhszBs7uKrfRgisSreY323K/TDI2/vhl4/pYxSYOu3U=')
ki.log("Auth Token : " + str(ki.authToken))
channel1 = LineChannel(ki)
ki.log("Channel Access Token : " + str(channel1.channelAccessToken))

kk = LineClient(authToken='EAFT4qVyKOukiwURAmY9.yjV0vPNwFl92A+vNsY+zcq.ejXGYJ+vL/Xyz8W0J9engfTNlgzfLxG7Y3NlJwEXfd4=')
kk.log("Auth Token : " + str(kk.authToken))
channel2 = LineChannel(kk)
kk.log("Channel Access Token : " + str(channel2.channelAccessToken))

kc = LineClient(authToken='EAChDgGWyXUKWoqUQBAe.EYWOUNDDWUv6ij3bl+fxdG.+ihELJBIIu8J10CZY6UrIaj/2eyNrVbqlBBZrnaBAnM=')
kc.log("Auth Token : " + str(kc.authToken))
channel3 = LineChannel(kc)
kc.log("Channel Access Token : " + str(channel3.channelAccessToken))

kb = LineClient(authToken='EAHe1faAdCS7LYJ1bUjf.1f6vhaZ2XNy4aZPVEe2RdW.5a5cbJLTn20ZwADb4s+e8F5pza+VoKOCy4PJV7L2LYo=')
kb.log("Auth Token : " + str(kb.authToken))
channel4 = LineChannel(kb)
kb.log("Channel Access Token : " + str(channel4.channelAccessToken))

sw = LineClient(authToken='EAx2pA8AYOOjTrAUYoYd.m8blJq9roJBMLXRuxOnDpq.qbtfbubWoN5Pvj+bedzH2kFyT8bvxZLozWNoMBxaBTw=')
...
poll = LinePoll(cl)
call = cl
creator = ["ubeb5254723ed114fbb8238d862503f80"]
owner = ["ubeb5254723ed114fbb8238d862503f80"]
admin = ["ubeb5254723ed114fbb8238d862503f80"]
staff = ["ubeb5254723ed114fbb8238d862503f80"]
sepriche = ["u9f09cfcb17d037e2936b751bd9d40ead"]
...
KAC = [cl,ki,kk,kc,kb,sw]
ABC = [cl,ki,kk,kc,kb,sw]
...
def help():
    ...
    helpMessage = "࿐MENU HELP࿐\n" + \
                  ...
                  "37." + key + "Resetkey\n" + \
                  "38." + key + "ID line:「Id Line nya」\n" + \
                  "39." + key + "Sholat:「Nama Kota」\n" + \
                  "40." + key + "Cuaca:「Nama Kota」\n" + \
                  "41." + key + "Lokasi:「Nama Kota」\n" + \
                  "42." + key + "Music:「Judul Lagu」\n" + \
                  "43." + key + "Lirik:「Judul Lagu」\n" + \
                  "44." + key + "Ytmp3:「Judul Lagu」\n" + \
                  "45." + key + "Ytmp4:「Judul Video」\n" + \
                  "46." + key + "Profileig:「Nama IG」\n" + \
                  "47." + key + "Cekdate:「tgl-bln-thn」\n" + \
                  "48." + key + "Jumlah:「angka」\n" + \
                  "49." + key + "Spamtag「@」\n" + \
                  "50." + key + "Spamcall:「jumlahnya」\n" + \
                  "51." + key + "Spamcall\n" + \
                  "52." + key + "Notag「on/off」\n" + \
                  "53." + key + "Allpro「on/off」\n" + \
                  "54." + key + "Protecturl「on/off」\n" + \
                  "55." + key + "Protectjoin「on/off」\n" + \
                  "56." + key + "Protectkick「on/off」\n" + \
                  "57." + key + "Protectcancel「on/off」\n" + \
                  "58." + key + ".stay\n" + \
                  "59." + key + "Clearban\n" + \
                  "60." + key + "Banlist\n" + \
                  "61." + key + "Sticker「on/off」\n" + \
                  "62." + key + "Respon「on/off」\n" + \
                  "63." + key + "Contact「on/off」\n" + \
                  "64." + key + "Autojoin「on/off」\n" + \
                  "65." + key + "Autoadd「on/off」\n" + \
                  "66." + key + "Welcome「on/off」\n" + \
                  "67." + key + "Autoleave「on/off」\n" + \
                  "68." + key + "Admin:on\n" + \
                  "69." + key + "Admin:repeat\n" + \
                  "70." + key + "Staff:on\n" + \
                  "71." + key + "Staff:repeat\n" + \
...
def helpbot():
    ...
    helpMessage1 = "HELP BOT\n" + \
                  ...
                  "100." + key + "Cek respon \n" + \
                  "101." + key + "Cek welcome\n" + \
                  "102." + key + "Set sider:「Text」\n" + \
                  "103." + key + "Set spam:「Text」\n" + \
                  "104." + key + "Set pesan:「Text」\n" + \
                  "105." + key + "Set respon:「Text」\n" + \
                  "106." + key + "Set welcome:「Text」\n" + \
                  "107." + key + "Myname:「Nama」\n" + \
                  "108" + key + "Bot1name:「Nama」\n" + \
                  "109." + key + "Bot2name:「Nama」\n" + \
                  "110." + key + "Bot3name:「Nama」\n" + \
                  "111." + key + "Bot1up「Kirim fotonya」\n" + \
                  "112." + key + "Bot2up「Kirim fotonya」\n" + \
                  "113." + key + "Bot3up「Kirim fotonya」\n" + \
                  "114." + key + "Gift:「Mid korban」「Jumlah」\n" + \
                  "115." + key + "Spam:「Mid korban」「Jumlah」\n" + \
                  "FunkZher"
    return helpMessage1
        ...
        if op.type == 19 or op.type == 32:
            if mid in op.param3:
                ...
                if op.param2 in staff:
                    ...
                    wait["blacklist"][op.param2] = True
                    try:
                        ki.inviteIntoGroup(op.param1,[mid,Amid,Bmid,Cmid,Dmid,Zmid])
                        cl.acceptGroupInvitation(op.param1)
                        ki.kickoutFromGroup(op.param1,[op.param2])
                    except:
                        try:
                            kk.inviteIntoGroup(op.param1,[mid,Amid,Bmid,Cmid,Dmid,Zmid])
                            cl.acceptGroupInvitation(op.param1)
                            kk.kickoutFromGroup(op.param1,[op.param2])
                        except:
                            try:
                                kc.inviteIntoGroup(op.param1,[mid,Amid,Bmid,Cmid,Dmid,Zmid])
                                cl.acceptGroupInvitation(op.param1)
                                kc.kickoutFromGroup(op.param1,[op.param2])
                            except:
                                try:
                                    ...
                                    try:
                                        sw.inviteIntoGroup(op.param1,[mid,Amid,Bmid,Cmid,Dmid,Zmid])
                                        cl.acceptGroupInvitation(op.param1)
                                        sw.kickoutFromGroup(op.param1,[op.param2])
                                    except:
                                        pass
                ...
                if op.param2 in staff:
                    ...
                    try:
                        ...
                        try:
                            ...
                            try:
                                kb.inviteIntoGroup(op.param1,[mid,Amid,Bmid,Cmid,Dmid,Zmid])
                                kb.acceptGroupInvitation(op.param1)
                                ki.kickoutFromGroup(op.param1,[op.param2])
                            except:
                                try:
                                    ...
                                    try:
                                        cl.inviteIntoGroup(op.param1,[mid,Amid,Bmid,Cmid,Dmid,Zmid])
                                        cl.acceptGroupInvitation(op.param1)
                                        ki.kickoutFromGroup(op.param1,[op.param2])
                                    except:
                                        pass
        ...
        if op.type == 5:
            if settings['autoBlock'] == True:
                try:
                    ...
                    cl.sendMessage(op.param1, "Haii {} Sorry Auto Block aktif".format(usr.displayName))
                        ...
                        if cmd == "self on":
                          ...
                          if wait["selfbot"] == True:
                            if msg._from in admin:
                               ...
                               restartBot()
                               cl.sendMessage(msg.to, "Restart done...")
                          ...
                          if msg._from in admin:
                            try:
                                ...
                                cl.sendMessage(msg.to, "࿐FunkZher Fams Grup Info\n\n࿐Nama Group : {}".format(G.name)+ "\n࿐ID Group : {}".format(G.id)+ "\n࿐Pembuat : {}".format(G.creator.displayName)+ "\n࿐Waktu Dibuat : {}".format(str(timeCreated))+ "\n࿐Jumlah Member : {}".format(str(len(G.members)))+ "\n࿐Jumlah Pending : {}".format(gPending)+ "\n࿐Group Qr : {}".format(gQr)+ "\n࿐Group Ticket : {}".format(gTicket))
...
#===========BOT UPDATE============#
                          ...
                          if wait["selfbot"] == True:
                            if msg._from in sepri:
                                ...
                                ki.sendMessage(msg.to,"aktif")
                                kk.sendMessage(msg.to,"aktif")
                                kc.sendMessage(msg.to,"aktif")
                                kb.sendMessage(msg.to,"aktif")
                                sw.sendMessage(msg.to,"aktif")
                          ...
                          if wait["selfbot"] == True:
                            if msg._from in admin:
                                try:
                                    anggota = [Bmid,Cmid,Amid,Dmid,Zmid]
                          ...
                          if wait["selfbot"] == True:
                            if msg._from in admin:
                                ...
                                cl.sendMessage(msg.to, "࿐FunkZher Speed respon\n\n - Get Profile\n   %.10f\n - Get Contact\n   %.10f\n - Get Group\n   %.10f" % (get_profile_time/3,get_contact_time/3,get_group_time/3))
                           ...
                           if msg._from in admin:
                              ...
                              for target in targets:                                                                                                                                       
                                  try:
                                      ...
                                      ki.cancelGroupInvitation(msg.to,[target])
                                      ki.inviteIntoGroup(msg.to,[target])
                                      ki.sendMessage(msg.to, "kapok wkwkwkk")
                                  except:
                                      pass
...
#=================================[ STAMINA BOT ]================================================                               
                            ...
                            if msg._from in admin or msg._from in owner:
                               ...
                               if has == "OK":sil = "bot fresh"
                               else:sil = "bot limit"
                               if has1 == "OK":sil1 = "bot fresh"
                               else:sil1 = " bot limit"
...
#===========COMMAND BLACKLIST============#
                          ...
                          if wait["selfbot"] == True:
                            if msg._from in admin:
                              ...
                              cl.sendMessage(msg.to,"Sukses membersihkan " )
#===========COMMAND SET============#
